...
public class BrandsPanel extends JPanel{
	...
	public BrandsPanel() {
		...
		//header of the panel
		JLabel lb1 = new JLabel("Manage Brands");
	...
	public static class JTableModel extends AbstractTableModel {
		...
		private static final String[] COLUMN_NAMES = {"Brands Name","Status","Edit","Delete"};
		...
		public void getData() {
			...
			try {
				...
				data1 = s;
				try {
					String retrive = "{call BrandsRetrive()}";
					cstmt = db.cn.prepareCall(retrive);
					rs = cstmt.executeQuery();
					int i = 0;
					while(rs.next()) {
						data1[i][0] = rs.getString("name");
		...
		@Override public Object getValueAt(final int rowIndex, final int columnIndex) {
			switch (columnIndex) {
				case 0: return data1[rowIndex][0];
				case 1: return data1[rowIndex][1];
				case 2: 
					...
					button1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							JFrame fm = new CustomJFrame("Enter the Brands name", "Enter the status", "Edit Brands", data1[rowIndex][0], data1[rowIndex][1]);
							fm.setMinimumSize (new Dimension (550, 300));
							fm.setUndecorated(true);
							fm.setVisible(true);
						}
				...
				case 3: // fall through
						...
						button.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								deleteData(data1[rowIndex][0]);
								JOptionPane.showMessageDialog(JOptionPane.getFrameForComponent(button), 
										"Row is delted"+rowIndex);
							}
						});
						return button;
