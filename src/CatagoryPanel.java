...
public class CatagoryPanel extends JPanel{
	...
	public CatagoryPanel() {
		...
		b.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				b.setBackground(MaterialColors.GREEN_200);
				JFrame fm = new CustomJFrame("Enter the catagory name", "Enter the status", "Add Catagory");
	...
	public static class JTableModel extends AbstractTableModel {
		...
		private static final String[] COLUMN_NAMES = new String[] {"Catagory Name", "Active Status", "Edit","Delete"};
		...
		public JTableModel(){
			...
			try {
				...
				data = s;
				try {
					String retrive = "{call Catagory_Retrive()}";
		...
		public void deleteData(String st) {
			...
			try {
				String delB = "{call CatagotyDelete(?)}";
				...
				case 2: 
					...
					button1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							JFrame fm = new CustomJFrame("Enter the Catagory name", "Enter the status", "Edit Catagory", data[rowIndex][0], data[rowIndex][1]);
							fm.setMinimumSize (new Dimension (550, 300));
							fm.setUndecorated(true);
							fm.setVisible(true);
						}
						...
						button.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								JOptionPane.showMessageDialog(JOptionPane.getFrameForComponent(button), 
										"The row number "+rowIndex + "is delete from the catagory table");
							}
						});
						return button;
